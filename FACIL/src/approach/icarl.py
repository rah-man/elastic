...
class Appr(Inc_Learning_Appr):
    ...
    def classify(self, task, features, targets):
        ...
        # print("hits_taw:", hits_taw)
        # print("hist_tag:", hits_tag)
        # exit()
        ...
        with override_dataset_transform(self.exemplars_dataset, transform) as _ds:
            ...
            with torch.no_grad():
                ...
                for images, targets in icarl_loader:
                    if self.exemplars_dataset.is_feature:
                        feats = images
                    else:
    ...
    def train_loop(self, t, trn_loader, val_loader):
        ...
        if t > 0:            
            # print(trn_loader.dataset)
            # print(self.exemplars_dataset)
            # print(trn_loader.dataset.is_feature)
            # print(self.exemplars_dataset.is_feature)
            # if trn_loader.dataset.is_feature:
            #     print(type(trn_loader.dataset[0][0]))
            #     print(type(self.exemplars_dataset[0][0]))
            #     exit()
                # for t in self.exemplars_dataset:
                #     print(t[0])
                #     print(t[1])
                #     exit()
                # for t in trn_loader.dataset:
                #     print(t[0])
                #     print(t[1])
                #     exit()
                # CREATE MANUALLY
